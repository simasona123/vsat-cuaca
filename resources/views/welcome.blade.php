        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <form class="flex flex-col items-center" action="" method="POST">
                ...
                <div class="flex flex-col sm:flex-row mt-5">
                    <div class="flex flex-row mt-2 items-center">
                        <div class="w-72">
                            <select
                                class="rounded-md border-gray-200 shadow-sm sm:text-sm p-3 pe-5 w-full" name="stasun"
                            >
                        ...
                        <svg class="relative right-9" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M575.8 255.5c0 18-15 32.1-32 32.1h-32l.7 160.2c0 2.7-.2 5.4-.5 8.1V472c0 22.1-17.9 40-40 40H456c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1H416 392c-22.1 0-40-17.9-40-40V448 384c0-17.7-14.3-32-32-32H256c-17.7 0-32 14.3-32 32v64 24c0 22.1-17.9 40-40 40H160 128.1c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2H104c-22.1 0-40-17.9-40-40V360c0-.9 0-1.9 .1-2.8V287.6H32c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z"/></svg>
                    </div>
                    <div class="flex flex-row mt-2 items-center">
                        <div class="w-72">
                            <select
                                class="rounded-md border-gray-200 shadow-sm sm:text-sm p-3 pe-5 w-full" name="cuaca"
                            >
                                <option value="cerah">Cerah</option>
                                <option value="hujan">Hujan</option>
                            </select>
                        </div>
                        <svg class="relative right-9" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M0 336c0 79.5 64.5 144 144 144H512c70.7 0 128-57.3 128-128c0-61.9-44-113.6-102.4-125.4c4.1-10.7 6.4-22.4 6.4-34.6c0-53-43-96-96-96c-19.7 0-38.1 6-53.3 16.2C367 64.2 315.3 32 256 32C167.6 32 96 103.6 96 192c0 2.7 .1 5.4 .2 8.1C40.2 219.8 0 273.2 0 336z"/></svg>
                    </div>
                </div>
            ...
            <div class="cuaca flex flex-col sm:flex-row justify-around mt-8 gap-4 w-full">
                <a href="#" class="flex flex-col justify-center items-center">
                    ...
                    <img
                        alt="Art"
                        src="https://bmkg.go.id/asset/img/icon-cuaca/berawan-am.png"
